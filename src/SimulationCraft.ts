...
let ParseModifier: (action, nodeList: LuaArray<Node>, annotation: Annotation) => [boolean, Node, Node] = undefined;
...
function PreOrderTraversalMark(node: Node) {
