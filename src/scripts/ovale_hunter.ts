...
{
    let name = "simulationcraft_hunter_mm_t19p";
    let desc = "[7.0] SimulationCraft: Hunter_MM_T19P";
    let code = `
...
{
    let name = "simulationcraft_hunter_sv_t19p";
    let desc = "[7.0] SimulationCraft: Hunter_SV_T19P";
    let code = `
