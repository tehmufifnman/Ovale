...
{
    let name = "simulationcraft_warlock_affliction_t19p";
    let desc = "[7.0] SimulationCraft: Warlock_Affliction_T19P";
    let code = `
...
{
    let name = "simulationcraft_warlock_demonology_t19p";
    let desc = "[7.0] SimulationCraft: Warlock_Demonology_T19P";
    let code = `
...
{
    let name = "simulationcraft_warlock_destruction_t19p";
    let desc = "[7.0] SimulationCraft: Warlock_Destruction_T19P";
    let code = `
