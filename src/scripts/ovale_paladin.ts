...
{
    let name = "simulationcraft_paladin_protection_t19p";
    let desc = "[7.0] SimulationCraft: Paladin_Protection_T19P";
    let code = `
...
{
    let name = "simulationcraft_paladin_retribution_t19p";
    let desc = "[7.0] SimulationCraft: Paladin_Retribution_T19P";
    let code = `
