...
{
    let name = "simulationcraft_mage_arcane_t19p";
    let desc = "[7.0] SimulationCraft: Mage_Arcane_T19P";
    let code = `
...
{
    let name = "simulationcraft_mage_fire_t19p";
    let desc = "[7.0] SimulationCraft: Mage_Fire_T19P";
    let code = `
...
{
    let name = "simulationcraft_mage_frost_t19p";
    let desc = "[7.0] SimulationCraft: Mage_Frost_T19P";
    let code = `
...
{
    let name = "simulationcraft_mage_ntspamarcane_t19p";
    let desc = "[7.0] SimulationCraft: Mage_NTSpamArcane_T19P";
    let code = `
