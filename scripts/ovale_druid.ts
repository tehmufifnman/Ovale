...
{
    let name = "simulationcraft_druid_balance_t19p";
    let desc = "[7.0] SimulationCraft: Druid_Balance_T19P";
    let code = `
...
{
    let name = "simulationcraft_druid_feral_t19p";
    let desc = "[7.0] SimulationCraft: Druid_Feral_T19P";
    let code = `
...
{
    let name = "simulationcraft_druid_guardian_t19p";
    let desc = "[7.0] SimulationCraft: Druid_Guardian_T19P";
    let code = `
