...
{
    let name = "simulationcraft_death_knight_frost_t19p";
    let desc = "[7.0] SimulationCraft: Death_Knight_Frost_T19P";
    let code = `
...
{
    let name = "simulationcraft_death_knight_unholy_t19p";
    let desc = "[7.0] SimulationCraft: Death_Knight_Unholy_T19P";
    let code = `
