...
{
    let name = "simulationcraft_shaman_elemental_t19p";
    let desc = "[7.0] SimulationCraft: Shaman_Elemental_T19P";
    let code = `
...
{
    let name = "simulationcraft_shaman_enhancement_t19p";
    let desc = "[7.0] SimulationCraft: Shaman_Enhancement_T19P";
    let code = `
