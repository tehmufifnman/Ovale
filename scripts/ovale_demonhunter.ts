...
{
    let name = "simulationcraft_demon_hunter_havoc_t19p";
    let desc = "[7.0] SimulationCraft: Demon_Hunter_Havoc_T19P";
    let code = `
...
{
    let name = "simulationcraft_demon_hunter_vengeance_t19p";
    let desc = "[7.0] SimulationCraft: Demon_Hunter_Vengeance_T19P";
    let code = `
