...
{
    let name = "simulationcraft_rogue_assassination_t19p";
    let desc = "[7.0] SimulationCraft: Rogue_Assassination_T19P";
    let code = `
...
{
    let name = "simulationcraft_rogue_outlaw_t19p";
    let desc = "[7.0] SimulationCraft: Rogue_Outlaw_T19P";
    let code = `
...
{
    let name = "simulationcraft_rogue_subtlety_t19p";
    let desc = "[7.0] SimulationCraft: Rogue_Subtlety_T19P";
    let code = `
