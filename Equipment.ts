...
{
    let armorSetName = { HUNTER: { ["T14"]: "T14_melee", ["T15"]: "T15_melee", ["T16"]: "T16_melee" }, MAGE: { ["T14"]: "T14_caster", ["T15"]: "T15_caster", ["T16"]: "T16_caster" }, ROGUE: { ["T14"]: "T14_melee", ["T15"]: "T15_melee", ["T16"]: "T16_melee" }, WARLOCK: { ["T14"]: "T14_caster", ["T15"]: "T15_caster" } }
class OvaleEquipment {
        GetArmorSetCount(name) {
            let count = this.armorSetCount[name];
            if (!count) {
                import { class } from "./playerClass";
                if (armorSetName[class] && armorSetName[class][name]) {
