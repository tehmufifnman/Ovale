...
let OvaleBestAction = Ovale.NewModule("OvaleBestAction", "AceEvent-3.0");
...
class OvaleBestAction {
    ...
    ComputeGroup(element, state, atTime) {
        ...
        for (const [_, node] of _ipairs(element.child)) {
