local OVALE, Ovale = ...
require(OVALE, Ovale, "ovale_druid_spells", { "./OvaleScripts" }, function(__exports, __OvaleScripts)
do
...
Define(wild_charge_talent 6)
    ...
    __OvaleScripts.OvaleScripts:RegisterScript("DRUID", nil, name, desc, code, "include")
end
end))
