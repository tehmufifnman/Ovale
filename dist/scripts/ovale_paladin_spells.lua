local OVALE, Ovale = ...
require(OVALE, Ovale, "ovale_paladin_spells", { "./OvaleScripts" }, function(__exports, __OvaleScripts)
do
...
Define(zeal_talent 5)
    ...
    __OvaleScripts.OvaleScripts:RegisterScript("PALADIN", nil, name, desc, code, "include")
end
end))
