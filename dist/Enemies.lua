local OVALE, Ovale = ...
require(OVALE, Ovale, "Enemies", { "./L", "./OvaleDebug", "./OvaleProfiler" }, function(__exports, __L, __OvaleDebug, __OvaleProfiler)
...
__OvaleDebug.OvaleDebug:RegisterDebugging(OvaleEnemies)
__OvaleProfiler.OvaleProfiler:RegisterProfiling(OvaleEnemies)
