...
__addon.require(__addonName, __addon, "./src/Runes", { "./src/Debug", "./src/Profiler", "./src/Ovale", "./src/Data", "./src/Power", "./src/State", "./src/PaperDoll" }, function(__exports, __Debug, __Profiler, __Ovale, __Data, __Power, __State, __PaperDoll)
