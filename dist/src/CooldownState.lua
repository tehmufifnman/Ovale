...
__addon.require(__addonName, __addon, "./src/CooldownState", { "./src/State", "./src/Cooldown", "./src/DataState", "./src/PaperDoll", "./src/Ovale", "./src/Data", "./src/Aura" }, function(__exports, __State, __Cooldown, __DataState, __PaperDoll, __Ovale, __Data, __Aura)
