...
__addon.require(__addonName, __addon, "./src/Aura", { "./src/Localization", "./src/Debug", "./src/Pool", "./src/Profiler", "./src/Data", "./src/GUID", "./src/PaperDoll", "./src/SpellBook", "./src/State", "./src/Ovale", "./src/LastSpell", "./src/Requirement", "./src/DataState" }, function(__exports, __Localization, __Debug, __Pool, __Profiler, __Data, __GUID, __PaperDoll, __SpellBook, __State, __Ovale, __LastSpell, __Requirement, __DataState)
