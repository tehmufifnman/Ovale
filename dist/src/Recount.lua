...
__addon.require(__addonName, __addon, "./src/Recount", { "./src/Ovale", "./src/Score", "src/AceLocale-3.0", "src/Recount" }, function(__exports, __Ovale, __Score, AceLocale, Recount)
