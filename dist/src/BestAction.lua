...
__addon.require(__addonName, __addon, "./src/BestAction", { "./src/Debug", "./src/Pool", "./src/Profiler", "./src/TimeSpan", "./src/ActionBar", "./src/Compile", "./src/Condition", "./src/Data", "./src/Equipment", "./src/GUID", "./src/SpellBook", "./src/Ovale", "./src/State", "./src/PaperDoll", "./src/DataState", "./src/SpellBookState", "./src/FutureState", "./src/CooldownState" }, function(__exports, __Debug, __Pool, __Profiler, __TimeSpan, __ActionBar, __Compile, __Condition, __Data, __Equipment, __GUID, __SpellBook, __Ovale, __State, __PaperDoll, __DataState, __SpellBookState, __FutureState, __CooldownState)
