...
__addon.require(__addonName, __addon, "./src/SimulationCraft", { "src/AceConfig-3.0", "src/AceConfigDialog-3.0", "./src/Localization", "./src/Debug", "./src/Options", "./src/Pool", "./src/Ovale", "./src/AST", "./src/Compile", "./src/Data", "./src/HonorAmongThieves", "./src/Lexer", "./src/Power", "./src/Controls" }, function(__exports, AceConfig, AceConfigDialog, __Localization, __Debug, __Options, __Pool, __Ovale, __AST, __Compile, __Data, __HonorAmongThieves, __Lexer, __Power, __Controls)
