...
__addon.require(__addonName, __addon, "./src/Totem", { "./src/Profiler", "./src/Ovale", "./src/Data", "./src/SpellBook", "./src/State", "./src/Aura", "./src/DataState" }, function(__exports, __Profiler, __Ovale, __Data, __SpellBook, __State, __Aura, __DataState)
