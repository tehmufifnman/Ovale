...
__addon.require(__addonName, __addon, "./src/SpellBookState", { "./src/State", "./src/SpellBook", "./src/Data", "./src/DataState", "./src/Power", "./src/CooldownState", "./src/Runes" }, function(__exports, __State, __SpellBook, __Data, __DataState, __Power, __CooldownState, __Runes)
local _type = type
