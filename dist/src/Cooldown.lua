...
__addon.require(__addonName, __addon, "./src/Cooldown", { "./src/Debug", "./src/Profiler", "./src/Data", "./src/SpellBook", "./src/Ovale", "./src/LastSpell", "./src/Requirement", "./src/DataState" }, function(__exports, __Debug, __Profiler, __Data, __SpellBook, __Ovale, __LastSpell, __Requirement, __DataState)
