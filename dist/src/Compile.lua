...
__addon.require(__addonName, __addon, "./src/Compile", { "./src/Debug", "./src/Profiler", "./src/Artifact", "./src/AST", "./src/Condition", "./src/Cooldown", "./src/Data", "./src/Equipment", "./src/PaperDoll", "./src/Power", "./src/Score", "./src/SpellBook", "./src/Stance", "./src/Ovale", "./src/Controls" }, function(__exports, __Debug, __Profiler, __Artifact, __AST, __Condition, __Cooldown, __Data, __Equipment, __PaperDoll, __Power, __Score, __SpellBook, __Stance, __Ovale, __Controls)
