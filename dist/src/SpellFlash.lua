...
__addon.require(__addonName, __addon, "./src/SpellFlash", { "./src/Localization", "./src/Options", "./src/Ovale", "./src/Data", "./src/Future", "./src/SpellBook", "./src/Stance", "./src/State" }, function(__exports, __Localization, __Options, __Ovale, __Data, __Future, __SpellBook, __Stance, __State)
