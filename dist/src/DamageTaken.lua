...
__addon.require(__addonName, __addon, "./src/DamageTaken", { "./src/Debug", "./src/Pool", "./src/Profiler", "./src/Queue", "./src/Ovale" }, function(__exports, __Debug, __Pool, __Profiler, __Queue, __Ovale)
