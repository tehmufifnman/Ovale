...
__addon.require(__addonName, __addon, "./src/Options", { "src/AceConfig-3.0", "src/AceConfigDialog-3.0", "./src/Localization", "src/AceDB-3.0", "src/AceDBOptions-3.0", "./src/Ovale" }, function(__exports, AceConfig, AceConfigDialog, __Localization, AceDB, AceDBOptions, __Ovale)
