...
__addon.require(__addonName, __addon, "./src/Scripts", { "src/AceConfig-3.0", "src/AceConfigDialog-3.0", "./src/Options", "./src/Localization", "./src/PaperDoll", "./src/Ovale" }, function(__exports, AceConfig, AceConfigDialog, __Options, __Localization, __PaperDoll, __Ovale)
