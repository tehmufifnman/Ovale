...
__addon.require(__addonName, __addon, "./src/SpellBook", { "./src/Localization", "./src/Debug", "./src/Profiler", "./src/Ovale", "./src/Requirement" }, function(__exports, __Localization, __Debug, __Profiler, __Ovale, __Requirement)
