...
__addon.require(__addonName, __addon, "./src/DataBroker", { "./src/Localization", "src/LibDataBroker-1.1", "src/LibDBIcon-1.0", "./src/Debug", "./src/Options", "./src/Ovale", "./src/Scripts", "./src/Version", "./src/Frame" }, function(__exports, __Localization, LibDataBroker, LibDBIcon, __Debug, __Options, __Ovale, __Scripts, __Version, __Frame)
