...
__addon.require(__addonName, __addon, "./src/Health", { "./src/Debug", "./src/Profiler", "./src/Ovale", "./src/GUID", "./src/State", "./src/Requirement" }, function(__exports, __Debug, __Profiler, __Ovale, __GUID, __State, __Requirement)
