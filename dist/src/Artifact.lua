...
__addon.require(__addonName, __addon, "./src/Artifact", { "src/LibArtifactData-1.0", "./src/Debug", "./src/Localization", "./src/Ovale" }, function(__exports, LibArtifactData, __Debug, __Localization, __Ovale)
