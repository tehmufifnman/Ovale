...
__addon.require(__addonName, __addon, "./src/Enemies", { "./src/Debug", "./src/Profiler", "./src/Ovale", "./src/GUID", "./src/State" }, function(__exports, __Debug, __Profiler, __Ovale, __GUID, __State)
