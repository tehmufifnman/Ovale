...
__addon.require(__addonName, __addon, "./src/Frame", { "src/AceGUI-3.0", "src/Masque", "./src/BestAction", "./src/Compile", "./src/Debug", "./src/FutureState", "./src/GUID", "./src/SpellFlash", "./src/State", "./src/Ovale", "./src/Icon", "./src/Enemies", "./src/Controls" }, function(__exports, AceGUI, Masque, __BestAction, __Compile, __Debug, __FutureState, __GUID, __SpellFlash, __State, __Ovale, __Icon, __Enemies, __Controls)
