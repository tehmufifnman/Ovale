...
__addon.require(__addonName, __addon, "./src/AST", { "./src/Localization", "./src/Pool", "./src/Profiler", "./src/Debug", "./src/Ovale", "./src/Lexer", "./src/Condition", "./src/Lexer", "./src/Scripts", "./src/SpellBook", "./src/Stance" }, function(__exports, __Localization, __Pool, __Profiler, __Debug, __Ovale, __Lexer, __Condition, __Lexer, __Scripts, __SpellBook, __Stance)
