...
__addon.require(__addonName, __addon, "./src/PassiveAura", { "./src/Ovale", "./src/Aura", "./src/Equipment", "./src/PaperDoll" }, function(__exports, __Ovale, __Aura, __Equipment, __PaperDoll)
