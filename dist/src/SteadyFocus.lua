...
__addon.require(__addonName, __addon, "./src/SteadyFocus", { "./src/Debug", "./src/Profiler", "./src/Ovale", "./src/Aura", "./src/SpellBook", "./src/State" }, function(__exports, __Debug, __Profiler, __Ovale, __Aura, __SpellBook, __State)
