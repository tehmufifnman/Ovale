...
__addon.require(__addonName, __addon, "./src/ComboPoints", { "./src/Debug", "./src/Profiler", "./src/Aura", "./src/Data", "./src/Equipment", "./src/PaperDoll", "./src/Power", "./src/SpellBook", "./src/Ovale", "./src/State", "./src/Requirement", "./src/LastSpell", "./src/DataState" }, function(__exports, __Debug, __Profiler, __Aura, __Data, __Equipment, __PaperDoll, __Power, __SpellBook, __Ovale, __State, __Requirement, __LastSpell, __DataState)
