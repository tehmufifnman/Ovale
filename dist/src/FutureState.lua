...
__addon.require(__addonName, __addon, "./src/FutureState", { "./src/Future", "./src/Cooldown", "./src/LastSpell", "./src/SpellBook", "./src/GUID", "./src/State", "./src/Ovale", "./src/PaperDoll", "./src/DataState", "./src/Stance" }, function(__exports, __Future, __Cooldown, __LastSpell, __SpellBook, __GUID, __State, __Ovale, __PaperDoll, __DataState, __Stance)
local _wipe = wipe
