...
__addon.require(__addonName, __addon, "./src/Power", { "./src/Localization", "./src/Debug", "./src/Profiler", "./src/Ovale", "./src/Aura", "./src/Future", "./src/Data", "./src/State", "./src/PaperDoll", "./src/Requirement", "./src/FutureState", "./src/LastSpell", "./src/DataState" }, function(__exports, __Localization, __Debug, __Profiler, __Ovale, __Aura, __Future, __Data, __State, __PaperDoll, __Requirement, __FutureState, __LastSpell, __DataState)
