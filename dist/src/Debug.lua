...
__addon.require(__addonName, __addon, "./src/Debug", { "src/AceConfig-3.0", "src/AceConfigDialog-3.0", "./src/Localization", "src/LibTextDump-1.0", "./src/Options", "./src/Ovale" }, function(__exports, AceConfig, AceConfigDialog, __Localization, LibTextDump, __Options, __Ovale)
