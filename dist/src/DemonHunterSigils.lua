...
__addon.require(__addonName, __addon, "./src/DemonHunterSigils", { "./src/Profiler", "./src/Ovale", "./src/PaperDoll", "./src/SpellBook", "./src/State" }, function(__exports, __Profiler, __Ovale, __PaperDoll, __SpellBook, __State)
