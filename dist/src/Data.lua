...
__addon.require(__addonName, __addon, "./src/Data", { "./src/Ovale", "./src/GUID", "./src/PaperDoll", "./src/State", "./src/Debug", "./src/Requirement" }, function(__exports, __Ovale, __GUID, __PaperDoll, __State, __Debug, __Requirement)
