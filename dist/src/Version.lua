...
__addon.require(__addonName, __addon, "./src/Version", { "./src/Localization", "./src/Debug", "./src/Options", "./src/Ovale" }, function(__exports, __Localization, __Debug, __Options, __Ovale)
