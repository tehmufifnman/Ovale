...
__addon.require(__addonName, __addon, "./src/Future", { "./src/Debug", "./src/Profiler", "./src/Ovale", "./src/Aura", "./src/Data", "./src/GUID", "./src/PaperDoll", "./src/SpellBook", "./src/LastSpell" }, function(__exports, __Debug, __Profiler, __Ovale, __Aura, __Data, __GUID, __PaperDoll, __SpellBook, __LastSpell)
