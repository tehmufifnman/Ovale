...
__addon.require(__addonName, __addon, "./src/PaperDoll", { "./src/Debug", "./src/Profiler", "./src/Ovale", "./src/Equipment", "./src/Stance", "./src/State", "./src/LastSpell" }, function(__exports, __Debug, __Profiler, __Ovale, __Equipment, __Stance, __State, __LastSpell)
